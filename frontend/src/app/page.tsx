    ...
    <div className="min-h-[calc(100vh-2rem)] flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center mb-16 space-y-2">
        <div className="mx-auto mb-4 w-fit">
          <Image src="/AZOV_logo.svg" alt="AZOV patch" width={30} height={52} className="h-12 w-auto mx-auto" priority />
        </div>
        <p className="wolf-title text-gray-500 tracking-[0.3em]">АЗОВ</p>
        <h1 className="text-3xl md:text-5xl font-bold tracking-widest text-white [font-family:var(--app-font-display)]">МЕДИЧНА СЛУЖБА</h1>
        <p className="wolf-title text-gray-400 tracking-[0.2em]">АЗОВ • МЕДИЧНИЙ КОНТУР • CCRM</p>
        <a
          href="https://azov.org.ua/"
          target="_blank"
          rel="noreferrer"
          className="inline-flex mt-3 items-center justify-center px-6 py-2 border border-[#7a6326] text-[#e3b60d] text-xs font-bold tracking-[0.2em] uppercase hover:bg-[#1b1b20] transition-colors"
        >
          АЗОВ
        </a>
      </div>
          ...
          <div className="p-8 flex-1">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-widest text-white leading-tight [font-family:var(--app-font-display)]">БОЙОВИЙ<br/>ДАШБОРД</h2>
              </div>
            </div>
          ...
          <div className="p-8 flex-1">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <h2 className="text-2xl font-bold tracking-widest text-white leading-tight [font-family:var(--app-font-display)]">КОМАНДНИЙ<br/>ЦЕНТР</h2>
              </div>
            </div>
