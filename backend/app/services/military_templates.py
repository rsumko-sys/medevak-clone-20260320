...
def generate_casualty_report(case_data: Dict[str, Any], member_data: Optional[Dict[str, Any]] = None) -> bytes:
...
def generate_medical_evacuation_form(case_data: Dict[str, Any], member_data: Optional[Dict[str, Any]] = None) -> bytes:
...
def generate_treatment_summary(case_data: Dict[str, Any], member_data: Optional[Dict[str, Any]] = None) -> bytes:
